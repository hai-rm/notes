...
kubectl logs --namespace uat statefulsets/lpfixgw-scb --tail=2000 | ~/codebase/fix2pipexx/fix2pipe++.py -t ~/codebase/reactive-cpp/reactive/fix/Tag.hpp -s name > view.txt
```
